#############################################################################
# Makefile for building: run/main
...
INCPATH       = -I. -Ibib -Igui_glut -Itrab1 -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++
...
COMPRESS      = gzip -9f
DISTNAME      = main1.0.0
DISTDIR = /home/david/Downloads/computer-graphics/run/.obj/main1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -lGL -lGLU -lglut -l3ds -lSDL_image -lIL   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
run/.obj/main.o: main.cpp gui_glut/gui.h \
		gui_glut/extra.h \
		bib/CameraDistante.h \
		bib/Camera.h \
		bib/Vetor3D.h \
...
run/.obj/Camera.o: bib/Camera.cpp bib/Camera.h \
		bib/Vetor3D.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o run/.obj/Camera.o bib/Camera.cpp

run/.obj/CameraDistante.o: bib/CameraDistante.cpp bib/CameraDistante.h \
		bib/Camera.h \
		bib/Vetor3D.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o run/.obj/CameraDistante.o bib/CameraDistante.cpp

run/.obj/CameraJogo.o: bib/CameraJogo.cpp bib/CameraJogo.h \
		bib/Camera.h \
		bib/Vetor3D.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o run/.obj/CameraJogo.o bib/CameraJogo.cpp

run/.obj/Desenha.o: bib/Desenha.cpp bib/Desenha.h \
		bib/Vetor3D.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o run/.obj/Desenha.o bib/Desenha.cpp

run/.obj/model3ds.o: bib/model3ds.cpp bib/model3ds.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o run/.obj/model3ds.o bib/model3ds.cpp

run/.obj/Vetor3D.o: bib/Vetor3D.cpp bib/Vetor3D.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o run/.obj/Vetor3D.o bib/Vetor3D.cpp

run/.obj/extra.o: gui_glut/extra.cpp gui_glut/extra.h \
		bib/CameraDistante.h \
		bib/Camera.h \
		bib/Vetor3D.h \
		bib/CameraJogo.h \
		bib/Desenha.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o run/.obj/extra.o gui_glut/extra.cpp

run/.obj/gui.o: gui_glut/gui.cpp gui_glut/gui.h \
		gui_glut/extra.h \
		bib/CameraDistante.h \
		bib/Camera.h \
		bib/Vetor3D.h \
		...
		bib/Desenha.h \
		bib/model3ds.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o run/.obj/gui.o gui_glut/gui.cpp
...
run/.obj/object.o: tb01/object.cpp headers/object.h \
		...
		bib/Desenha.h \
		bib/model3ds.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o run/.obj/object.o tb01/object.cpp

run/.obj/brick.o: tb01/brick.cpp headers/brick.h \
		gui_glut/gui.h \
		gui_glut/extra.h \
		bib/CameraDistante.h \
		bib/Camera.h \
		...
		headers/object.h \
		utils/utils.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o run/.obj/brick.o tb01/brick.cpp

run/.obj/tree.o: tb01/tree.cpp headers/tree.h \
		gui_glut/gui.h \
		gui_glut/extra.h \
		bib/CameraDistante.h \
		bib/Camera.h \
